                ...
                <div class="col-lg-12">
                    <div class="li-section-title">
                        <h2>
                            ...
                            <span style="text-transform: capitalize;">{{ $vrProductCategory->name }}</span>
                            {{-- @endif --}}
                        </h2>
                        <ul class="li-sub-category-list">
                            <li class="active"><a href="shop-left-sidebar.html">Prime Video</a></li>
                    ...
                    <div class="row">
                        <div class="product-active owl-carousel">
                            {{-- {{ dd($vrProducts) }} --}}
                            @foreach ($vrProducts as $vrProduct)
                                <div class="col-lg-12">
                                    <!-- single-product-wrap start -->
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            @php
                                                $imagesLink = is_null($vrProduct->image) || !file_exists('images/' . $vrProduct->image) ? 'https://phutungnhapkhauchinhhang.com/wp-content/uploads/2020/06/default-thumbnail.jpg' : asset('images/' . $vrProduct->image);
                                            @endphp
                                            <a href="single-product.html">
                                                <img src="{{ $imagesLink }}" alt="Li's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                        </div>
                                        <div class="product_desc">
                                            ...
                                            <div class="add-actions">
                                                <ul class="add-actions-link">
                                                    <li class="add-cart active">
                                                        <a class="add-to-cart"
                                                            data-url="{{ route('product.add-to-cart', ['productId' => $vrProduct->id]) }}">Add
                                                            to cart</a>
                                                    </li>
