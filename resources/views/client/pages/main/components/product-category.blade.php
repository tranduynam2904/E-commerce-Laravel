                        ...
                        <div class="ttfeatured-content products grid owl-carousel" id="owl1">
                                    ...
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/01.jpg') }}"
                                                alt="01" />
                                            <img src="{{ asset('assets/client/img/products/02.jpg') }}"
                                ...
                                <div class="product-thumb">
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/02.jpg') }}"
                                                alt="02" />
                                            <img src="{{ asset('assets/client/img/products/03.jpg') }}" alt="03"
                            ...
                            <div class="product-layouts">
                                <div class="product-thumb">
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/03.jpg') }}"
                                                alt="03" />
                                            <img src="{{ asset('assets/client/img/products/04.jpg') }}"
                                ...
                                <div class="product-thumb">
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/04.jpg') }}"
                                                alt="04" />
                                            <img src="{{ asset('assets/client/img/products/05.jpg') }}"
                                ...
                                <div class="product-thumb">
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/05.jpg') }}"
                                                alt="05" />
                                            <img src="{{ asset('assets/client/img/products/06.jpg') }}"
                                ...
                                <div class="product-thumb">
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/06.jpg') }}"
                                                alt="06" />
                                            <img src="{{ asset('assets/client/img/products/07.jpg') }}"
                                ...
                                <div class="product-thumb">
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/07.jpg') }}"
                                                alt="07" />
                                            <img src="{{ asset('assets/client/img/products/08.jpg') }}"
                                ...
                                <div class="product-thumb">
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/08.jpg') }}"
                                                alt="03" />
                                            <img src="{{ asset('assets/client/img/products/09.jpg') }}"
                        ...
                        <div class="ttbestseller-content products grid owl-carousel" id="owl3">
                                    ...
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/04.jpg') }}"
                                                alt="03" />
                                            <img src="{{ asset('assets/client/img/products/05.jpg') }}"
                                                alt="05" class="second_image img-responsive" /></a>
                                        <div class="button-wrapper">
                                            <div class="button-group text-center">
                                                <button type="button" class="btn btn-primary btn-cart"
                                                    data-toggle="modal" data-target="#product_view"><i
                            ...
                            <div class="product-layouts">
                                <div class="product-thumb">
                                    <div class="image vertical_scrolling_top_to_bottom">
                                        <a href="product-details.html">
                                            <img src="{{ asset('assets/client/img/products/06.jpg') }}" alt="03" /></a>
                                        <div class="button-wrapper">
                                            <div class="button-group text-center">
                                                <button type="button" class="btn btn-primary btn-cart"
                                                    data-toggle="modal" data-target="#product_view"><i
