                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            {{-- {{ dd($permissions->id) }} --}}
                            <form method="POST"
                                action="{{ route('backend.permissions.update', ['permission' => $permissions->id]) }}"
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="guard_name">Guard Name
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="guard_name" class="form-control col-md-7 col-xs-12"
