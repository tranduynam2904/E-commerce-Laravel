                    ...
                    <div class="card">
                        <div class="card-body bg1">
                            ...
                            <div class="testimonial-carousel owl-carousel">
                                <div class="tst-item">
                                    <div class="tstu-img">
                                        <img src="{{ asset('assets/admin/images/team/team-author1.jpg') }}"
                                            alt="author image">
                                    </div>
                                    <div class="tstu-content">
                                        <h4 class="tstu-name">Abel Franecki</h4>
                                        <span class="profsn">Designer</span>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae laborum ut nihil
                                            numquam a aliquam alias necessitatibus ipsa soluta quam!</p>
                                    </div>
                                </div>
                                <div class="tst-item">
                                    <div class="tstu-img">
                                        <img src="{{ asset('assets/admin/images/team/team-author2.jpg') }}"
                                            alt="author image">
                                    </div>
                                    <div class="tstu-content">
                                        <h4 class="tstu-name">Abel Franecki</h4>
                                ...
                                <div class="tst-item">
                                    <div class="tstu-img">
                                        <img src="{{ asset('assets/admin/images/team/team-author3.jpg') }}"
                                            alt="author image">
                                    </div>
                                    <div class="tstu-content">
                                        <h4 class="tstu-name">Abel Franecki</h4>
